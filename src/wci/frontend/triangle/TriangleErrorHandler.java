 ...
 */
public class TriangleErrorHandler
{
     ...
     */
    public void flag(Token token, TriangleErrorCode errorCode, Parser parser)
    {
     ...
     * @param parser the parser.
     */
    public void abortTranslation(TriangleErrorCode errorCode, Parser parser)
    {
