...
public class Triangle
{
     ...
     */
    public Triangle(String operation, String filePath, String flags)
    {
        try {
            ...
            parser = FrontendFactory.createParser("Triangle", "top-down", source);
    ...
    private static final String USAGE =
        "Usage: Triangle execute|compile " + FLAGS + " <source file path>";
    ...
    public static void main(String args[])
    {
        try {
            ...
            if (i < args.length) {
                String path = args[i];
                new Triangle(operation, path, flags);
            }
            else {
                throw new Exception();
            }
